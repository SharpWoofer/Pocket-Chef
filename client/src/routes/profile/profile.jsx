    ...
    return (
      ...
      />
            <Box
                width="45%"
            >
                <Grid item direction="row" alignItem="center" xs={2} marginLeft={2} marginTop={3}
                      justifyContent="space-around" sx={{display: "flex"}}>
                    <Box sx={{
                        width: "13rem",
                        height: "16rem",
                        borderRadius: "20px",
                                ...
                                <div className="percent">
                                    <svg>
                                        ...
                                        <circle cx="70" cy="70" r="70" style={{
                                            strokeDashoffset: "calc(440 - (440 * 57) / 100)",
                                            stroke: "#27A468"
                                        }}></circle>
                                    </svg>
                                    <div className="num">
                            ...
                            <Box className="box" sx={{marginLeft: '1.5em'}}>
                                <div className="percent">
                                    <svg>
                                        <circle cx="70" cy="70" r="70"></circle>
                                        <circle cx="70" cy="70" r="70" style={{
                                            strokeDashoffset: "calc(440 - (440 * 28) / 100)",
                                            stroke: "#E53761"
                                        }}></circle>
                                    </svg>
                                    <div className="num">
